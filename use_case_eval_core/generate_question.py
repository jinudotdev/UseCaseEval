...
def build_generator_prompt(use_case, num_tests):
    return (
        ...
        "Do not create inputs that rely on missing prior conversation, hidden context, images, highlights, uploaded files, web access, or external tools.\n"
        "Prompts should be concise, practical, and varied, but complete enough to answer without extra context.\n"
